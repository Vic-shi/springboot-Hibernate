package com.example.auction.application.util.createId;
...
public class CreateId{
    ...
    /**必须以0开始 16进制*/
    public static String s_16="01234567890";
    public static CreateId me=new CreateId();
    /**id池*/
    ...
    public String to62(Long val){
        ...
        return toX(val,s_16.length(),s_16);
